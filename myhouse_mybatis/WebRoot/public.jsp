			...
			<DIV class="dialog">
				...
				<DIV class="box">
					<FORM id="add_action" method="post" name="addhouse"
						action="publichouse.action" enctype = "multipart/form-data">
						<DIV class="infos">
							<TABLE class="field">
								<TBODY>
									<TR>
										...
										<TD>
											<INPUT id="add_title" class="text" type="text" name="house.title">
										</TD>
									</TR>
									<TR>
										<TD class="field">
									...
									<TR>
										...
										<TD>
											<INPUT id="add_price" class="text" type="text" name="house.price">
										</TD>
									</TR>
									<TR>
										<TD class="field">
										...
										<TD>
											<INPUT class="text" type="text" name="house.housedate" id = "add_housedate">
										</TD>
									</TR>
									<TR>
										<TD class="field">
									...
									<TR>
										...
										<TD>
											<TEXTAREA name="house.content" id = "add_description"></TEXTAREA>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
